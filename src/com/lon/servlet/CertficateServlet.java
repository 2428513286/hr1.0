...
import com.lon.dao.impl.CertficateDaoImpl;
import com.lon.entity.Certficate;


/**
 * Servlet implementation class CertficateServlet
 */
@WebServlet("/CertficateServlet")
public class CertficateServlet extends HttpServlet {
	...
	public void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		c.setEduid(Integer.parseInt(eduid));
		c.setName(name);
		c.setCode(code);
		try {
			c.setGetDate(new SimpleDateFormat("yyyy-MM-dd").parse(getDate));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		CertficateDao dao = new CertficateDaoImpl();
		dao.add(c);
		queryByPage(request, response);
	}
	...
	public void queryById(HttpServletRequest request, HttpServletResponse response)
		...
		CertficateDao dao = new CertficateDaoImpl();
		Certficate c = dao.queryById(Integer.parseInt(id));
		request.setAttribute("certficate", c);
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.setAttribute("currentPage",currentPage);
		request.getRequestDispatcher("certficate/update.jsp").forward(request, response);
	}
	...
	public void queryByPage(HttpServletRequest request, HttpServletResponse response)
		...
		List<Certficate> list = dao.queryByPage(sp, pageSize, condition);
		...
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.getRequestDispatcher("certficate/list.jsp").forward(request, response);
	}
