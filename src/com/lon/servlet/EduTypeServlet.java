...
import com.lon.dao.impl.EduTypeDaoImpl;
import com.lon.entity.EduType;


/**
 * Servlet implementation class EduTypeServlet
 */
...
public class EduTypeServlet extends HttpServlet {
	...
	public void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		EduType d = new EduType();
		d.setName(name);

		EduTypeDao dao = new EduTypeDaoImpl();
		dao.add(d);
		queryByPage(request, response);
	}
	...
	public void queryById(HttpServletRequest request, HttpServletResponse response)
		...
		EduTypeDao dao = new EduTypeDaoImpl();
		EduType e = dao.queryById(Integer.parseInt(id));
		request.setAttribute("eduType", e);
	...
	public void queryByPage(HttpServletRequest request, HttpServletResponse response)
		...
		List<EduType> list = dao.queryByPage(sp, pageSize, condition);
