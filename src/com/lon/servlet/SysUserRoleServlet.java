...
/**
 * Servlet implementation class SysUserRoleServlet
 */
@WebServlet("/SysUserRoleServlet")
public class SysUserRoleServlet extends HttpServlet {
	...
	public void queryById(HttpServletRequest request, HttpServletResponse response)
		...
		SysUserRoleDao dao = new SysUserRoleDaoImpl();
		SysUserRole s = dao.queryById(Integer.parseInt(id));
		request.setAttribute("sysUserRole", s);
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.setAttribute("currentPage", currentPage);
		request.getRequestDispatcher("sysUserRole/update.jsp").forward(request, response);
	}
	...
	public void queryByPage(HttpServletRequest request, HttpServletResponse response)
		...
		List<SysUserRole> list = dao.queryByPage(sp, pageSize, condition);
		...
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.getRequestDispatcher("sysUserRole/list.jsp").forward(request, response);
	}
