...
public class ArchiveServlet extends HttpServlet {
	...
	public void queryById(HttpServletRequest request, HttpServletResponse response)
		...
		ArchiveDao dao = new ArchiveDaoImpl();
		Archive a = dao.queryById(Integer.parseInt(id));
		request.setAttribute("archive", a);
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.setAttribute("currentPage",currentPage);
		request.getRequestDispatcher("archive/update.jsp").forward(request, response);
	}
	...
	public void queryByPage(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("qname", qname);
		request.setAttribute("qmanager", qmanager);
		request.getRequestDispatcher("archive/list.jsp").forward(request, response);
	}
